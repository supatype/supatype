...
// ─── SVG Icons ────────────────────────────────────────────────────────────────
//
// Feather-style line icons, drawn inline rather than pulled from a package: two dozen 24x24 paths
// weigh less than the dependency, and every one of them is already the same stroke weight and grid.
//
// They live here rather than beside the first view that needed them. They were private to the
// sidebar, so the second view wanting a chevron had the choice of importing from `Sidebar.tsx`,
// which says nothing about icons, or drawing its own slightly different one. This is the module the
// design system's icons belong in, and the sidebar is now one of its callers.

export function IconHome({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconGrid({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconDatabase({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconImage({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconUsers({ size = 16 }: { size?: number }): React.ReactElement {
  return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
}
export function IconMail({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconZap({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconRadio({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconPlug({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconLightbulb({ size = 16 }: { size?: number }): React.ReactElement {
  return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="9" y1="18" x2="15" y2="18"/><line x1="10" y1="22" x2="14" y2="22"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14"/></svg>
}
export function IconEye({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconList({ size = 16 }: { size?: number }): React.ReactElement {
  return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>
}
export function IconBook({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconGlobe({ size = 16 }: { size?: number }): React.ReactElement {
  return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
}
export function IconClock({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconCpu({ size = 16 }: { size?: number }): React.ReactElement {
  return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="1" x2="9" y2="4"/><line x1="15" y1="1" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="23"/><line x1="15" y1="20" x2="15" y2="23"/><line x1="20" y1="9" x2="23" y2="9"/><line x1="20" y1="14" x2="23" y2="14"/><line x1="1" y1="9" x2="4" y2="9"/><line x1="1" y1="14" x2="4" y2="14"/></svg>
}
export function IconShoppingCart({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconBarChart2({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconGitBranch({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconLink({ size = 16 }: { size?: number }): React.ReactElement {
  return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
}
export function IconBot({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconSettings({ size = 16 }: { size?: number }): React.ReactElement {
...
export function IconChevronRight({ size = 13 }: { size?: number }): React.ReactElement {
...
// ─── Publishing ───────────────────────────────────────────────────────────────
//
// Actions on a draft, drawn small enough to sit inline on a 280px sidebar row beside a locale and
// its badge. Words for these ("Publish", "Unpublish", "Schedule instead") pushed every locale onto
// three lines of its own.

export function IconUpload({ size = 14 }: { size?: number }): React.ReactElement {
...
export function IconEyeOff({ size = 14 }: { size?: number }): React.ReactElement {
...
export function IconX({ size = 14 }: { size?: number }): React.ReactElement {
...
export function IconHistory({ size = 14 }: { size?: number }): React.ReactElement {
  return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v5h5"/><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"/><polyline points="12 7 12 12 15 14"/></svg>
}
